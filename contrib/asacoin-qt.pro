...
RESOURCES += src/qt/asacoin.qrc src/qt/asacoin_locale.qrc

TRANSLATIONS += src/qt/locale/asacoin_bg.ts \
                src/qt/locale/asacoin_de.ts \
                src/qt/locale/asacoin_en.ts \
                src/qt/locale/asacoin_es.ts \
                src/qt/locale/asacoin_fi.ts \
                src/qt/locale/asacoin_fr.ts \
                src/qt/locale/asacoin_it.ts \
                src/qt/locale/asacoin_ja.ts \
                src/qt/locale/asacoin_pl.ts \
                src/qt/locale/asacoin_pt.ts \
                src/qt/locale/asacoin_ru.ts \
                src/qt/locale/asacoin_sk.ts \
                src/qt/locale/asacoin_sv.ts \
                src/qt/locale/asacoin_vi.ts \
                src/qt/locale/asacoin_zh_CN.ts \
                src/qt/locale/asacoin_zh_TW.ts
