...
#define MyAppName "ASA Core"
#define MyAppPublisher "2022 ASA Core Developers"
#define MyAppURL "https://asacoin.net"
#define MyAppExeName "asacoin-qt.exe"
#define MyAppExtraData "https://explorer.asacoin.net/bootstraps/ASA/bootstrap.zip"
...
[Files]
Source: ".\package\asacoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\ASA\ASA-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\ASA\ASA-Qt,strDataDir|{userappdata}\ASA\}');
  Result := True;
end;
