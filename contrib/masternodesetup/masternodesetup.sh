...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='asacoin.conf'
CONFIGFOLDER='/root/.asacoin'
COIN_DAEMON='asacoind'
COIN_CLI='asacoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/asacoin910/asacoin/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
