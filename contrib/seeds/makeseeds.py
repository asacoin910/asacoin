...
def main():
    ...
    # Filter out hosts with multiple asacoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple asacoin ports' % (ip_stats(ips)), file=sys.stderr)
