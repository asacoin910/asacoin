...
The build script we'll be using is contained in the ASA github repository ([contrib/gitian-build.py](https://github.com/asacoin910/asacoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the ASA repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/ASA-Project/ASA/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, asacoin-detached-sigs, and asacoin GitHub repos.
