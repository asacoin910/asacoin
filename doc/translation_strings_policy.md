...
This document provides guidelines for internationalization of the ASA Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to ASA network</source>
        <translation>
            <numerusform>%n active connection to ASA network</numerusform>
            <numerusform>%n active connections to ASA network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `asacoin_en.ts` remains unchanged.
