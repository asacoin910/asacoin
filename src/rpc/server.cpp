...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ASA features */
        {"asacoin", "listmasternodes", &listmasternodes, true },
        {"asacoin", "getmasternodecount", &getmasternodecount, true },
        {"asacoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"asacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"asacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"asacoin", "masternodecurrent", &masternodecurrent, true },
        {"asacoin", "startmasternode", &startmasternode, true },
        {"asacoin", "createmasternodekey", &createmasternodekey, true },
        {"asacoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"asacoin", "listmasternodeconf", &listmasternodeconf, true },
        {"asacoin", "getmasternodestatus", &getmasternodestatus, true },
        {"asacoin", "getmasternodewinners", &getmasternodewinners, true },
        {"asacoin", "getmasternodescores", &getmasternodescores, true },
        {"asacoin", "preparebudget", &preparebudget, true },
        {"asacoin", "submitbudget", &submitbudget, true },
        {"asacoin", "mnbudgetvote", &mnbudgetvote, true },
        {"asacoin", "getbudgetvotes", &getbudgetvotes, true },
        {"asacoin", "getnextsuperblock", &getnextsuperblock, true },
        {"asacoin", "getbudgetprojection", &getbudgetprojection, true },
        {"asacoin", "getbudgetinfo", &getbudgetinfo, true },
        {"asacoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"asacoin", "mnfinalbudget", &mnfinalbudget, true },
        {"asacoin", "checkbudgets", &checkbudgets, true },
        {"asacoin", "mnsync", &mnsync, true },
        {"asacoin", "spork", &spork, true },
...
{
    return "> asacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19330/\n";
}
