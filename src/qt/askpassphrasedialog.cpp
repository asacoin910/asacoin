...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ASAGUI* window = static_cast<ASAGUI*>(parentWidget());
...
{
    ASAGUI* gui = static_cast<ASAGUI*>(parentWidget());
...
{
    hide();
    static_cast<ASAGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("ASA will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your ASAs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
