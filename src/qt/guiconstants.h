...
/* ASA GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ASA"
#define QAPP_ORG_DOMAIN "asacoin.org"
#define QAPP_APP_NAME_DEFAULT "ASA-Qt"
#define QAPP_APP_NAME_TESTNET "ASA-Qt-testnet"
