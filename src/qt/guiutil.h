...
/** Utility functions used by the ASA Qt UI.
 */
namespace GUIUtil
{
...
// Render ASA addresses in monospace font
...
// Parse "asacoin:" URI into recipient object, return true on successful parsing
