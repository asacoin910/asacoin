...
#include "qt/asacoin/forms/ui_addresseswidget.h"
#include "qt/asacoin/addresslabelrow.h"
#include "qt/asacoin/addnewaddressdialog.h"
#include "qt/asacoin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(ASAGUI* parent) :
    PWidget(parent),
