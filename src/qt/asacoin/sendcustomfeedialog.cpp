...
#include "qt/asacoin/sendcustomfeedialog.h"
#include "qt/asacoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ASAGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ASAGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
