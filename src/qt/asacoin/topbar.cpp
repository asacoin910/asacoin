...
#include "qt/asacoin/forms/ui_topbar.h"
#include "qt/asacoin/loadingdialog.h"
#include "qt/asacoin/lockunlock.h"
#include "qt/asacoin/qtutils.h"
#include "qt/asacoin/receivedialog.h"
...
TopBar::TopBar(ASAGUI* _mainWindow, QWidget* parent) : PWidget(_mainWindow, parent),
                                                        ui(new Ui::TopBar)
{
    ui->setupUi(this);
    ...
    ui->pushButtonConf->setButtonText("asacoin.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open asacoin.conf with default application"));
}
