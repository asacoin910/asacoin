...
#include "qt/asacoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/asacoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ASAGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the ASA RPC console.") + "<br>" +
