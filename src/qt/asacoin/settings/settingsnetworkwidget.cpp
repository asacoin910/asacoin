...
#include "qt/asacoin/settings/settingsnetworkwidget.h"
#include "qt/asacoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/asacoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ASAGUI* _window, QWidget *parent) :
