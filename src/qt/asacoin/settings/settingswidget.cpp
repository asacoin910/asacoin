...
#include "qt/asacoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(ASAGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &ASAGUI::openFAQ);
