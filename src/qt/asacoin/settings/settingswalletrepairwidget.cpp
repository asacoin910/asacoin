...
#include "qt/asacoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/asacoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ASAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ASAGUI::handleRestart()
