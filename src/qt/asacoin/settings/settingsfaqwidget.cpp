...
#include "qt/asacoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/asacoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(ASAGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableASA,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableASA,
    ...
    connect(ui->pushButton_UnspendableASA, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableASA);});
    ...
    if (parent)
        connect(parent, &ASAGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
