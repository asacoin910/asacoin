...
#ifndef ASA_CORE_NEW_GUI_ASAGUI_H
#define ASA_CORE_NEW_GUI_ASAGUI_H
...
#include "qt/asacoin/navmenuwidget.h"
#include "qt/asacoin/topbar.h"
#include "qt/asacoin/dashboardwidget.h"
#include "qt/asacoin/send.h"
#include "qt/asacoin/receivewidget.h"
#include "qt/asacoin/addresseswidget.h"
#include "qt/asacoin/masternodeswidget.h"
#include "qt/asacoin/snackbar.h"
#include "qt/asacoin/settings/settingswidget.h"
...
/**
  ASA GUI main class. This class represents the main window of the ASA UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ASAGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ASAGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~ASAGUI();
...
#endif //ASA_CORE_NEW_GUI_ASAGUI_H
