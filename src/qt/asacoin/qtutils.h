...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ASAGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ASAGUI* gui, double posX = 3);
