...
#include "qt/asacoin/furabstractlistitemdelegate.h"
#include "qt/asacoin/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/asacoin/txviewholder.h"
...
#include "config/asacoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(ASAGUI* _window);
    ~DashboardWidget();
