...
{
    const char* pszTimestamp = "Members of public begin to pay respect to the Queen at St Giles' Cathedral";
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1663008850, 175728, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000004481b5997020103a49b6ef9f5cb718519b69b53a7bf77a1dae2cb9b898c"));
        ...
        vSeeds.push_back(CDNSSeedData("155.138.231.93", "155.138.231.93"));
...
public:
    CTestNetParams()
    {
	    ...
	    vSeeds.push_back(CDNSSeedData("tseed8", "tseed8.asacoin.net"));
