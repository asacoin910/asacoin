...
from test_framework.test_framework import AsaTestFramework
...
class ReorgStakeTest(AsaTestFramework):
    ...
    def check_money_supply(self, expected_bib, expected_zbib):
        ...
        # verify that nodes have the expected ASA and zASA supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_bib))
            for denom in node['zASAsupply']:
                assert_equal(node['zASAsupply'][denom], DecimalAmt(expected_zbib[denom]))
    ...
    def run_test(self):
        ...
        # Check ASA and zASA supply at the beginning
        # ------------------------------------------
        # zASA supply: 2 coins for each denomination
        ...
        # ASA supply: block rewards minus burned fees for minting
        ...
        # Verify that ASA and zASA supplies were properly updated after the spends and reorgs
        self.log.info("Check ASA and zASA supply...")
