Contributing to ASA Core
============================

The ASA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/asacoin910/asacoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ASA Core project, and is not to be
confused with overall ASA Network Protocol consensus changes.

Whether a pull request is merged into ASA Core rests with the project merge
...
Patches that change ASA consensus rules are considerably more involved than
...
Where a patchset proposes to change the ASA consensus, it must have been
...
The project leader is the release manager for each ASA Core release.
